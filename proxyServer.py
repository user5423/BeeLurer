...
class proxyReqHandler(socketserver.BaseRequestHandler):
    ...
    def setTCPStreamCallback(self, callback: Callable) -> None:
        self.callback = callback

    def setupLocalProxyConnection(self) -> None:
    ...
    def handle(self) -> None:
        ...
        ##NOTE: This function will be called on streams of data segmented into blocks of up to 1024 bytes. If the http request spans
        ##two blocks, or there is two http requests in a block, then the callback won't be able to handle individual http requests
